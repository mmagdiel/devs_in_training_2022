...
def get_center_number(number_1, number_2, number_3):
    if type(number_1)==type(list()) or type(number_2)==type(list()) or type(number_3)==type(list()) or number_1==str(number_1) or number_2==str(number_2) or number_3==str(number_3):
         return 0
